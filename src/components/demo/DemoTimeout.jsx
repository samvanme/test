      ...
      >
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          {onRetry && (
            <button
              onClick={onRetry}
              className="px-4 py-2 min-h-[44px] bg-brand-blue text-white font-bold text-sm uppercase tracking-wider border-2 border-white shadow-brutal-sm hover:shadow-brutal active:translate-x-0.5 active:translate-y-0.5 transition-all"
            >
              Keep Waiting
            </button>
          )}
          {onCancel && (
            <button
              onClick={onCancel}
              className="px-4 py-2 min-h-[44px] bg-transparent text-slate-400 font-bold text-sm uppercase tracking-wider border-2 border-slate-600 hover:border-slate-500 hover:text-white transition-all"
            >
              Cancel
            </button>
          )}
