...
export default function DemoAgent({
  ...
  return (
    <div className="relative bg-slate-900/50 border-0 sm:border-2 border-white/10 hover:border-white/20 transition-colors flex-1 sm:h-[60vh] lg:h-[65vh] sm:min-h-[400px] lg:min-h-[450px] sm:max-h-[750px] flex flex-col overflow-hidden">
      {/* Left accent bar */}
